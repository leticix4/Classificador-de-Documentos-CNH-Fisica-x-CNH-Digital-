...
def main():
    pasta_imagens = Path( r"C:\Users\letic\OneDrive\Documentos\SI\Classificador-de-Documentos-CNH-Fisica-x-CNH-Digital-\cnh_fisica\imagens_transformadas_legiveis"
    )
    
    csv_saida = "features_CNH_fisica.csv"
